...
**表示可能性的情态动词**: 用 may、might 和 could 等情态动词表达可能性。 注意，在其后使用动词的一般式。 May 和 might 的含义基本相同，但 may 较为正式。
...
I realized, when I woke up, it's time for a change of lifestyle, 'cause if I don't-well, I don't even want to think about it.
