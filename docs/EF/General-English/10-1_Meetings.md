...
* 以下是一些商务会议中可以用到的名词：
  * There are five items on today's **agenda**.	今天的日程有五项。| agenda 议事日程 | Any last minute items to be added to the **agenda** ? | How many items are there on the **agenda**? 日程上有几个事项？
  * The **merger** of our two companies is still going ahead.	我们两家公司的并购还在进行中。| merger 合并 | It's not one company buying another. It's a **merger** .
  * The final decision will be made by the **CEO**.	CEO会做出最终决定。
  * The **CFO** is responsible for reporting all company income.	CFO负责汇报公司营收。
  * John is our new marketing **executive**.	John是我们的新任销售主管。executives 执行总监
  * Our biggest **challenge** is to increase our market share.	我们最大的挑战是增加市场份额。| challenge 艰巨的任务，难题 | A good manager can deal with any **challenge** .| Executives expect to deal with **challenges**. 管理层必须面对挑战。

* 以下是一些商务会议中可以用到的动词：
  * We have to **figure out** a solution to this problem.	我们必须想办法解决这个问题。| figuring out 想出，弄明白 | We have to **figure out** a way to solve the problem. 我必须找出解决问题的办法| I'm sure if we all work together, we can **figure** it out.
  * Their CEO **resigned** last week.	他们的CEO上周辞职了。| resigned 辞职 | The board of directors forced her to **resign** . | Did the CEO **resign** or was he fired? CEO是自愿辞职还是被解雇的？
  * They just **fired** their marketing executive.	他们刚把销售主管辞了。

* 以下是一些商务会议中可以用到的形容词：
  * The figures in the report were not **accurate**.	报告中的数据不准确。| accurate 准确的 | The financial report must be completely **accurate** . | The CFO is responsible for the numbers being **accurate**. CFO 要对数据的准确性负责
  * I was not **aware** how serious the situation was.	我不知道情况有这么严重。aware 意识到的
...
* **Does everyone have an agenda？ As you can see,** we have three items to discuss today. 大家都拿到日程表了吗？ | Do you all have the agenda? 大家都拿到议事日程了吗

对到场的人表示感谢十分重要。

* **Thank you all for coming today**, I know how busy you all are./ I know that you're busy. 感谢各位的到来，我知道大家都很忙

确保每个到场人员明白会议目的

* **The purpose of today's meeting is** [to discuss the CFO's resignation and her replacement /to discuss the merger/a company update]今天会议的目的是讨论CFO的离职和下一任人选问题/公司合并/汇报一下公司的最新情况 | The purpose of this meeting is to...  本次会议的目的是。。
* **We are here because** a competitor has proposed a merger with our company. 有家竞争对手提出要和我们公司合并，今天的会议就是要讨论这个问题。 | The five of us are here because... 我们五个人来到这里，是因为.. | We are here to figure out a solution.
* **The first item on the agenda is** a company update from the CEO. 日程第一项是由CEO发布公司最新动态 | The first iten on the agenda is ... 会议议程第一项是。。。 | The second item on the agenda is the update.
...
* I/We need more detailed information 我需要更多详细的信息
...
* **The primary problem is** [a difference in management style/communication]. 首要问题是管理方式的不同。

* **The biggest challenge we face is** growing competition. 我们面临的最大挑战是日益激烈的竞争。｜ A huge challenge for me is ... 对我而言，一个艰巨的任务是...
...
* **For instance**, they don't return our phone calls. 比如，他们不回我们的电话。｜ For instance .. 比如...| For instance, our market share is small. 
...
|    **Noun**          |       **Verb** |
| ----------- | ----------- |
| start (a good start 好的开始) | start       |
| budget 预算 | budget      |
| promise 承诺 | promise     |
| evaluate 评定 | evaluation  |
...
* How could we take the idea one step **further**?	我们怎么可以让这个问题的讨论更进一步？| further 更进一步地  | We like your idea, but we'd like to take it **further**. 
* What do you think about **team building**? Would that solve the problem?	你怎么看团队建设？团队建设可以解决问题吗？| team building 团队建设 | Do **team-building** exercises improve morale? 团队建设训练是否可以提高士气？ | I like **team building**, but it doesn't solve everything.
* We need to do something to improve employee **morale**.	我们需要提高员工士气。 | morale 士气 | We hope the salary increase will improve **morale** .
* The negotiations are off to a **good start**. 谈判会有一个良好的开端 | After an **excellent** **start**, the idea went nowhere.
* I can't **promise** you a bigger budget for that project. 我不能保证可以给这个项目增加预算 | 

* What exactly do you **propose** as a solution? 那么你的解决方案到底是什么？ | What about the solution I **proposed** month?
...
* 以下是不同意的表达：
  * I'm not sure I agree with that. (mild disagreement)	我不确定我是否同意（温和）｜ Hang on a minute. I'm not sure I agree with you. 等一下。我不确定我是否跟你观点一致。
...
* **间接或礼貌的提议**
  * **One way to solve the problem might be** to increase the training budget.	增加培训预算可以是解决问题的一个方法。｜ One way to solve the problem might be ... 一种解决问题的办法可能是……
  * **At least let's talk about** increasing the training budget.	至少要讨论一下增加培训预算的问题。｜ At least let's send them to ... 至少让我们把他们送到……｜One way to solve the problem is to change the seating. 解决这个问题的方法之一是改变座次。
  * **How difficult would it be to** increase the training budget?	增加培训预算很难吗？｜ How difficult would it be to ... ? ……会有多难？
* **正式或直接的提议**
  * **I'd like to propose that** we increase the training budget.	我想提议提高培训预算。｜I'd like to propose ... 我想提议……
  * **I propose that** we increase the training budget.	我提议提高培训预算。｜I propose that excellent employees get rewarded. 我提议表现出色的员工应该受到奖赏。
...
* task    任务 -- job | She completed all of her **tasks** smoothly. 她顺利地完成了所有任务。
* coming up with 提出 -- create | We need to **come up with** a coordination plan. 我们需要制定一个协调计划。
* coordination 协作
* smoothly 平稳地，流畅地  -- easily
* back and forth 来回地，反复地 | This **back and forth** between Paris and London is tough. 这样往返于巴黎和伦敦之间真的挺磨人的
* in charge 负责，主管 | Who will be **in charge** while you're away? 你不在的时候谁负责？
* involve 涉及 -- include | The meeting will **involve** a lot of different people. 这次会议会有很多不同的人参加。
* conclude 结束 -- finish | The sooner we can **conclude** the deal, the better. 越快完成交易越好。
* keep me informed 让我了解情况
* rumors 谣言 -- gossip | I've informed the board about the merger **rumors**. 我已经向董事会汇报了并购传言
...
* 用一般将来时**will**和其否定形式**won't**来表示自愿做某事、承诺或预测。
  * I**'ll** help you.	我帮你。|I'm sure that team coordination **will** improve.	我相信团队协作会有改进的。|Do you think she **will come up** with a solution soon?|I **will be** glad to help you. What do you need?
  * I promise I **won't** spread any rumors.	我保证不散播任何谣言。| They promised they **won't** spread any rumors.
  * 
...
* 用将来进行时**will**或**be going to**加动词be和一个现在分词来谈论将来会发生的持续性的动作。
  * I**'ll be doing** some back and forth between here and Mexico.	我会从这儿到墨西哥之间往返好几趟。| She **will be** managing the office next week. | He'll be **traveling** all next month.
...
* **The next item on the agenda is** an update from our CFO.	 	日程下一项是来自CFO的最新信息。|The next point of discussion is …| The next item on the agenda is …

* **Moving on, let's discuss** the plan to expand overseas.	 	下一步，让我们来讨论一下海外扩张的问题。|Moving on, let's discuss …

* **Oh, and one more thing: we need to discuss** a change in employee insurance.	 	哦，还有一件事。我们要讨论一下员工保险的一个变动。|Oh, and one more thing ...  哦，还有一件事……

有时候讨论会偏题。如果讨论偏题，可以用这些表达来带回主题：

* **Now, as I was saying,** our competitive situation in Europe has changed.	 	正像我刚才说的，我们在欧洲的竞争局面已经发生了变化。|Now, as I was saying ...  现在，正如我所说的……

* **Now, where was I? Oh, yes** – the sales figures for last quarter.	 	我刚说到哪儿了？哦，是的，上个季度的销售额。

* **Getting back to my point**, I think a merger is not an option.	 	回到我的观点，我认为并购是不可取的。|Getting back to my point …
...
* 用这些表达来谈论未来计划。表达未来自愿做某事时，人们会使用**will**。
  * **I'll follow up on** finding a better location for the office.	我会继续寻找更好的办公地点。|I'll follow up on the idea of ...  我后续会关注……的主意
  * **Moving forward**, we will need to learn more about our competition.	未来我们需要了解更多竞争对手的情况。
* 当下一步需要间接地提出命令时，经理可以用“let's”。
  * **As a next step, let's** all think about ways to improve communication.	下一步，让我们想想如何改进沟通。|As a next step ...  接下来……|As a next step, I'll follow up with a company report. 下一步我会跟进一份公司报告
* 用这些表达来讨论保密性：
  * I just want to say again that **this discussion is confidential**.	我只想再说一遍，这次讨论是保密的。|Everything we've discussed is strictly confidential. 我们的所有谈话内容严格保密
  * Nothing we've discussed here **leaves this room**.	所有我们在这儿说过的话都不会离开这个屋子。|Nothing leaves this room. 出了这个房间跟谁也别说。
* 用这些表达来结束会议以及感谢与会者：
  * OK, that's it for now. Thank you all for coming.	好了，就到这儿。感谢大家的参加。| I want to thank you all for a very productive meeting. 感谢大家到会，这次会议很有成效
...
| doubt 怀疑     | doubt           |
| pressure       | pressure        |
| replace 替代   | replacement     |
| integrate 合并 | integration     |
...
* **a mess** 一团糟 | She was replaced because her department was **a mess**. 她被换下来是因为她的部门很乱。
* That **makes sense.** 那很有道理。 | We think it **makes sense** to integrate the two companies. 我们认为两家公司合并很有必要。
* I **turned** it **down**. 我拒绝了它。 | He t**urned down** the job of chief operating officer. 他拒绝了一份首席运营官的工作。
* I don't have any doubts or **regrets** about my decision. 对于我的决定我没有半点怀疑或后悔。
* board of directors 董事会 | There's a lot of pressure from the **board of directors**. 来自董事会的压力很大。
...
* 用这些表达来表示遗憾。注意，that可用可不用。
  * **I wish I had** accepted the job.	我要是接受这份工作就好了。|I wish that I'd pushed David more. 我希望我多鼓励一下 David 就好了。
  * **She regrets that she didn't** accept the position.	她后悔没有接受这个职位。
  * **She regrets** turning down the position.	她后悔拒绝这份工作。
  * **We should have** hired the other candidate.	我们当时应该雇用另外一个候选人。|We all should've pushed David more. 我们所有人都该多鼓励一下 David。
...
- Finally. 终于。
- The board has decided not to replace ... 董事会决定不更换……｜ The board **has decided to** hire him. Finally. 终于，董事会决定启用他。
...
* I think the decision was a smart move. 我认为这个决定很明智｜Smart move. 明智之举。
...
* I suggested **we move quickly.**	我建议快点行动。｜I **suggested** that he **take** the job.	我建议他接受这份工作。
